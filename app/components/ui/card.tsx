...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-2xl border border-white/10 bg-slate-900/75 p-6 backdrop-blur-xl shadow-2xl shadow-black/40',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'text-lg font-bold leading-none tracking-tight text-gray-100',
      className,
    )}
    {...props}
  />
